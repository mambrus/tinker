...
#ifdef TBD
static unsigned long lock_stage_ny(unsigned long qid, unsigned long timeout);
static unsigned long unlock_stage_ny(unsigned long qid);
#endif
...
@todo documet this
*/
unsigned long q_vreceive_ny(unsigned long qid, unsigned long flags, unsigned long timeout, void *msg_buf, unsigned long buf_len,	/* The size of your allocated buffer */
...
@todo documet this
*/
unsigned long q_delete_ny(unsigned long qid	/* id */
    )
{
	unsigned long rc;
