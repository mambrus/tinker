...
//------1---------2---------3---------4---------5---------6---------7---------8
int pthread_condattr_init (pthread_condattr_t *__attr){assert("Not implemented yet" == 0); return 0;}
int pthread_condattr_destroy (pthread_condattr_t *__attr){assert("Not implemented yet" == 0); return 0;}
