...
#endif
//------1---------2---------3---------4---------5---------6---------7---------8// The following are rerouted by bacros, so they need to be public. Don't use// in appl. code//void           _tk_assertfail( char *assertstr, char *filestr, int line ); <-- moved to assert.h//int           *_tk_errno(); <-- moved to errno.h//------1---------2---------3---------4---------5---------6---------7---------8/*- private functions **/
#if defined(TINKER)
