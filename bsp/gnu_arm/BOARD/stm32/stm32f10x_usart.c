...
void USART_Init(USART_TypeDef * USARTx, USART_InitTypeDef * USART_InitStruct)
{
	...
	assert(IS_USART_HARDWARE_FLOW_CONTROL
...
/*---------------------------- USART CR2 Configuration -----------------------*/
	...
	tmpreg |=
	    (u32) USART_InitStruct->
	    USART_StopBits | USART_InitStruct->USART_Clock | USART_InitStruct->
	    USART_CPOL | USART_InitStruct->USART_CPHA | USART_InitStruct->
	    USART_LastBit;
...
/*---------------------------- USART BRR Configuration -----------------------*/
	...
	integerdivider =
	    ((0x19 * apbclock) / (0x04 * (USART_InitStruct->USART_BaudRate)));
